...
exigir_login() roda ANTES de montar a navegação - sem uma senha correta
(st.secrets["APP_PASSWORD"]), nenhuma página (nem os dados, nem o chat)
chega a renderizar. Ver paginas/_util_auth.py.
...
paginas = st.navigation([
    ...
    st.Page("paginas/7_extrato.py", title="Extrato Diário", icon="📋"),
    st.Page("paginas/8_publicidade.py", title="Publicidade", icon="📣"),
